...
`decision-register.md` is authoritative for structural and process decisions. Current accepted range: DR-001 through DR-021.

## Current Architecture Baseline

- Reference Architecture: v1.4, accepted 2026-05-18
