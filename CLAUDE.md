...
`decision-register.md` is authoritative for structural and process decisions. Current accepted range: DR-001 through DR-037 (excluding superseded/deprecated entries).
