...
`decision-register.md` is authoritative for structural and process decisions. Current accepted range: DR-001 through DR-042 (excluding superseded/deprecated entries).
